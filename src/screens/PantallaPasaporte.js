...
const CAPITALES = {
  ...
  AL:{lat:41.3317,lng:19.8319},
  AT:{lat:48.2082,lng:16.3738},
  BA:{lat:43.8476,lng:18.3564},
  ...
  PK:{lat:33.7294,lng:73.0931},
  PS:{lat:31.9522,lng:35.2332},
  QA:{lat:25.2854,lng:51.531},
  SA:{lat:24.6877,lng:46.7219},
  SG:{lat:1.3521,lng:103.8198},
  SY:{lat:33.5102,lng:36.2913},
  TH:{lat:13.7563,lng:100.5018},
  TJ:{lat:38.5598,lng:68.787},
  TL:{lat:-8.5569,lng:125.5789},
  ...
  AO:{lat:-8.839,lng:13.2894},
  BF:{lat:12.3647,lng:-1.5333},
  BI:{lat:-3.3731,lng:29.9189},
  BJ:{lat:6.3703,lng:2.3912},
  BW:{lat:-24.6282,lng:25.9231},
  CD:{lat:-4.3317,lng:15.3139},
  CF:{lat:4.3947,lng:18.5582},
  CG:{lat:-4.2634,lng:15.2429},
  CI:{lat:6.8276,lng:-5.2893},
  CM:{lat:3.848,lng:11.5021},
  CV:{lat:14.933,lng:-23.5133},
  DJ:{lat:11.572,lng:43.1456},
  DZ:{lat:36.7372,lng:3.0865},
  EG:{lat:30.0444,lng:31.2357},
  ER:{lat:15.3229,lng:38.9251},
  ET:{lat:9.025,lng:38.7469},
  GA:{lat:0.4162,lng:9.4673},
  GH:{lat:5.56,lng:-0.2057},
  GM:{lat:13.4531,lng:-16.5775},
  GN:{lat:9.6412,lng:-13.5784},
  GQ:{lat:3.7523,lng:8.7741},
  GW:{lat:11.8636,lng:-15.5977},
  KE:{lat:-1.2921,lng:36.8219},
  KM:{lat:-11.7022,lng:43.2551},
  LR:{lat:6.3156,lng:-10.8074},
  LS:{lat:-29.3167,lng:27.4833},
  LY:{lat:32.901,lng:13.1805},
  MA:{lat:34.0209,lng:-6.8416},
  MG:{lat:-18.9137,lng:47.5361},
  ML:{lat:12.6392,lng:-8.0029},
  MR:{lat:18.0858,lng:-15.9785},
  MU:{lat:-20.1654,lng:57.4989},
  MW:{lat:-13.9669,lng:33.7873},
  MZ:{lat:-25.9692,lng:32.5732},
  NA:{lat:-22.5597,lng:17.0832},
  NE:{lat:13.5137,lng:2.1098},
  NG:{lat:9.0579,lng:7.4951},
  RW:{lat:-1.9441,lng:30.0619},
  SC:{lat:-4.6191,lng:55.4513},
  SD:{lat:15.5518,lng:32.5324},
  ...
  SZ:{lat:-26.5225,lng:31.1368},
  TD:{lat:12.1048,lng:15.0445},
  TG:{lat:6.1375,lng:1.2123},
  TN:{lat:36.819,lng:10.1658},
  TZ:{lat:-6.173,lng:35.7382},
  UG:{lat:0.3476,lng:32.5825},
  ZA:{lat:-25.7479,lng:28.2293},
  ZM:{lat:-15.4167,lng:28.2833},
  ZW:{lat:-17.8292,lng:31.0522},
  AU:{lat:-35.2809,lng:149.13},
  FJ:{lat:-18.1416,lng:178.4419},
  FM:{lat:6.9248,lng:158.161},
  KI:{lat:-1.329,lng:173.0237},
  MH:{lat:7.1315,lng:171.1845},
  NR:{lat:-0.5477,lng:166.9209},
  NZ:{lat:-41.2865,lng:174.7762},
  PG:{lat:-9.4438,lng:147.1803},
  PW:{lat:7.5,lng:134.624},
  SB:{lat:-9.4456,lng:160.0117},
  TO:{lat:-21.1393,lng:-175.2049},
  TV:{lat:-8.52,lng:179.1983},
  VU:{lat:-17.7334,lng:168.321},
  WS:{lat:-13.8314,lng:-171.7667},
};
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            {paisesVisitadosConCoords.map(pais => (
              ...
              >
                <View style={s.mapaPin}>
                  <Text style={{ fontSize: 20 }}>{pais.emoji}</Text>
                </View>
              </Marker>
            ))}
          </MapView>
            ...
            {filtrados.map(pais => {
              ...
              return (
                ...
                >
                  ...
                  {d.ciudades.length > 0 && (
                    <Text style={s.ciudadesCount}>{d.ciudades.length}🏙️</Text>
                  )}
                </TouchableOpacity>
              );
            })}
...
const s = StyleSheet.create({
  ...
  header:          { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', paddingHorizontal: 16, paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' },
  titulo:          { flex: 1, fontSize: 20, fontWeight: '800', color: '#1a1a1a' },
  headerBotones:   { flexDirection: 'row', alignItems: 'center', gap: 8 },
  vistaBtn:        { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12, backgroundColor: '#f3f4f6' },
  vistaBtnActivo:  { backgroundColor: '#2563eb' },
  vistaBtnT:       { fontSize: 12, fontWeight: '600', color: '#555' },
  vistaBtnTActivo: { color: '#fff' },
  cerrar:          { backgroundColor: '#f3f4f6', borderRadius: 14, width: 30, height: 30, alignItems: 'center', justifyContent: 'center', marginLeft: 4 },
  cerrarT:         { fontSize: 14, color: '#555' },
  ...
  progressT:       { fontSize: 11, color: '#888', marginTop: 6, textAlign: 'center', marginBottom: 8 },
  mapaPin:         { backgroundColor: '#fff', borderRadius: 20, padding: 4, shadowColor: '#000', shadowOpacity: 0.2, shadowRadius: 4, elevation: 4 },
  mapaVacio:       { position: 'absolute', bottom: 30, left: 20, right: 20, backgroundColor: 'rgba(0,0,0,0.65)', borderRadius: 14, padding: 16, alignItems: 'center' },
  mapaVacioT:      { color: '#fff', fontSize: 13, textAlign: 'center', lineHeight: 20 },
  contTabs:        { paddingHorizontal: 16, gap: 8, paddingBottom: 8, paddingTop: 8 },
  contTab:         { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, backgroundColor: '#fff', borderWidth: 1.5, borderColor: '#e5e7eb' },
  contTabActivo:   { backgroundColor: '#2563eb', borderColor: '#2563eb' },
  contTabT:        { fontSize: 11, fontWeight: '600', color: '#555' },
  contTabTActivo:  { color: '#fff' },
  ...
  paisCard:        { width: '30%', backgroundColor: '#fff', borderRadius: 14, padding: 10, alignItems: 'center', borderWidth: 2, borderColor: '#e5e7eb' },
  paisCardV:       { borderColor: '#2563eb', backgroundColor: '#eff6ff' },
  paisEmoji:       { fontSize: 24, marginBottom: 3 },
  paisNombre:      { fontSize: 10, fontWeight: '600', color: '#555', textAlign: 'center' },
  paisNombreV:     { color: '#1e40af' },
  check:           { fontSize: 12, color: '#2563eb', fontWeight: '700', marginTop: 2 },
  ciudadesCount:   { fontSize: 10, color: '#6366f1', marginTop: 1 },
  ...
  modalCont:       { backgroundColor: '#fff', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, paddingBottom: 36 },
  ...
  cerrarModal:     { backgroundColor: '#f0f0f0', borderRadius: 14, width: 28, height: 28, alignItems: 'center', justifyContent: 'center' },
  toggleBtn:       { backgroundColor: '#f0f4ff', borderRadius: 12, paddingVertical: 12, alignItems: 'center', borderWidth: 1.5, borderColor: '#c7d7ff' },
  toggleBtnActivo: { backgroundColor: '#2563eb', borderColor: '#2563eb' },
  toggleBtnT:      { fontWeight: '700', fontSize: 13 },
  secLabel:        { fontSize: 11, fontWeight: '700', color: '#888', textTransform: 'uppercase', letterSpacing: 0.5 },
  addRow:          { flexDirection: 'row', gap: 8, marginBottom: 12 },
  input:           { flex: 1, backgroundColor: '#f5f5f5', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 9, fontSize: 14, color: '#1a1a1a', borderWidth: 1, borderColor: '#e5e7eb' },
  addBtn:          { backgroundColor: '#2563eb', borderRadius: 10, width: 44, alignItems: 'center', justifyContent: 'center' },
  addBtnT:         { color: '#fff', fontWeight: '700', fontSize: 20 },
  ciudadFila:      { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' },
