...
const s = StyleSheet.create({
  ...
  relChipActivo:  { backgroundColor: '#5c1011', borderColor: '#5c1011' },
  ...
  cardVisitado:   { backgroundColor: '#faf6f0', borderWidth: 1, borderColor: '#bbf7d0' },
  ...
  fichaEnMapaBtn:    { backgroundColor: '#5c1011', borderRadius: 10, paddingHorizontal: 12, paddingVertical: 8 },
